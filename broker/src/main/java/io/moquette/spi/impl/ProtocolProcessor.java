...
import io.moquette.server.ClusterClient;
...
import io.moquette.util.DatabaseClient;
...
public class ProtocolProcessor {
    ...
    private ClusterClient m_clusterClient;
    ...
    public void processConnect(Channel channel, ConnectMessage msg) {
        ...
        System.out.println("Got client : " + msg.getClientID());
        // Record connected client information in database
        DatabaseClient.record_client_connected(msg.getClientID());
    ...
    public IMessagesStore getMessageStore(){
    ...
    public void processPublish(Channel channel, PublishMessage msg) {
        ...
        m_clusterClient.sendBroadCast(msg);
    ...
    public void directSend(ClientSession clientsession, String topic, AbstractMessage.QOSType qos,
